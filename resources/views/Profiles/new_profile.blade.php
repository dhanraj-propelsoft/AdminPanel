            ...
            <div class="card-body col-12">
                    ...
                    <div class="col-lg-12 d-flex justify-content-between flex-wrap">
                        <div class="col-lg-3">
                            <label for="imgInp" class="profile-img-container m-auto">
                                ...
                                @if ($PersonDatas['profile_pic'])
                                    <img src="{{ asset('profiles/' . $PersonDatas['profile_pic']) }}" id="blah"
                                        alt="Person Profile">
                                @else
                                    <img src="{{ asset('img/images (1).png') }}" id="blah" alt="Person Profile">
                                @endif
                                <!-- <img class="img-circle" id="myImg"  name="image" src=""> -->
                        ...
                        <div class="col-lg-9">
                            <div class="form-row">
                                        ...
                                        <select class="form-select w-100 AlterInput search-need" name="salutationId"
                                            ...
                                            @foreach ($salutation as $key => $value)
                                                <option value="{{ $value['id'] }}"
                                                    {{ $PersonDatas['salutation_id'] == $value['id'] ? 'selected' : '' }}>
                                                    {{ $value['salutation'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group col-md-4">
                                    <label class="form-group  p-0   InputLabel w-100">
                                        <input type="text" value="{{ $PersonDatas['first_name'] }}" name="firstName"
                                ...
                                <div class="form-group col-md-6">
                                    <label class="form-group  p-0   InputLabel w-100 ">
                                        <input type="text" name="middleName" value="{{ $PersonDatas['first_name'] }}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="form-group  p-0   InputLabel w-100 ">
                                        <input type="text" name="lastName" value="{{ $PersonDatas['last_name'] }}"
                                ...
                                <div class="form-group col-md-6">
                                    <label class="form-group  p-0   InputLabel w-100 ">
                                        <input type="text" name="nickName" value="{{ $PersonDatas['nick_name'] }}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="form-group  p-0   InputLabel w-100 ">
                                        <input type="text" placeholder="date" autocomplete="off"
                                            value="{{ date('d/m/Y', strtotime($PersonDatas['dob'])) }}" name="dob"
                                            validationAttr="date"
                                ...
                                <div class="form-group col-md-6">
                                    <label class="form-group  p-0   InputLabel w-100 ">
                                        <input type="text" name="birthCity" value="{{ $PersonDatas['birth_place'] }}"
                                ...
                                . InputLabel w-100 ">
                                        <select class="form-select w-100 AlterInput search-need" name="genderId"
                                            ...
                                            @foreach ($gender as $key => $value)
                                                <option value="{{ $value['id'] }}"
                                                    {{ $PersonDatas['gender_id'] == $value['id'] ? 'selected' : '' }}>
                                                    {{ $value['gender'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                . InputLabel w-100 ">
                                        <select class="form-select w-100 AlterInput search-need" name="bloodGroup"
                                            ...
                                            @foreach ($bloodGroup as $key => $value)
                                                <option value="{{ $value['id'] }}"
                                                    {{ $PersonDatas['blood_group_id'] == $value['id'] ? 'selected' : '' }}>
                                                    {{ $value['blood_group'] }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-row">
                                ...
                                . InputLabel w-100 ">
                                        <select class="form-select w-100 AlterInput search-need" name="maritalStatus"
                                            ...
                                            @foreach ($maritalStatus as $key => $value)
                                                <option value="{{ $value['id'] }}"
                                                    {{ $PersonDatas['marital_id'] == $value['id'] ? 'selected' : '' }}>
                                                    {{ $value['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="form-group  p-0   InputLabel w-100 ">
                                        <input type="text" name="anniversaryDate" value=""
                                            class="form-control AlterInput w-100 " placeholder="Anniversary Date...">
                ...
                <div id="customButtons3">
                    <div class="form-row">
                        <div class="form-group col-md-2 ">
                            <label class="input-group   p-0   InputLabel w-100 m-1">
                                <input type="text" name="mobileNumber" value="{{ $PersonDatas['mobile_no'] }}"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2 ">
                            <label class="input-group  p-0   InputLabel w-100 m-1">
                                <input type="email" name="email" value="{{ $PersonDatas['email'] }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".next-btn").click(function() {
                ...
                let contForm = $(this).closest("form").find("input.needValidation , select.needValidation");
