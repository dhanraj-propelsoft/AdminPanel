...
@section('content')
    ...
    <div class="row m-2 d-flex justify-content-center align-items-center change-password-container" vh="150">
        ...
        <form action="{{ route('changePassword') }}" method="post" id="organisation_form"
            class="form-horizontal col-lg-5 p-4 card propel-card rounded shadow-none" role="form" onsubmit="return false">
            @csrf
            ...
            <label class="form-group col-md-12 p-0  InputLabel mb-4">
                <input class="form-control AlterInput propel-key-press-input-mendatory oldPassword" type="text"
            ...
            <label class="form-group col-md-12 p-0  InputLabel mb-4 ">
                <input class="form-control AlterInput propel-key-press-input-mendatory newPassword" type="text"
            ...
            <label class="form-group col-md-12 p-0  InputLabel mb-4">
                <input class="form-control AlterInput propel-key-press-input-mendatory confPassword" type="text"
