            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('personEmailOtp')}}" id="person" class="frm-single" method="post" autocomplete="off">
                            @csrf
                            <div class="alert alert-danger" id="error" style="display: none;"></div>
                            <div class="alert alert-success" id="successAuth" style="display: none;"></div>

                            <label class="form-group col-md-12 p-0  InputLabel mb-4">
                                <input class="form-control AlterInput" id="otp" type="text" id="verification" placeholder="Enter OTP Received on your Mobile {{$mobile}}" name="otp" value="{{ old('otp') }}" />
                           ...
                           <input type="hidden" id="number" name="mobileNumber" value="{{$mobileNumber}}">
                            ...
                            <div class="d-flex justify-content-between">
                                <button class="propelbtn propelbtnrounded propelreset Resend" type="button">Resend OTP</button>
                                <button class="propelbtn propelbtnrounded propellogin Validate"  type="button">Validate</button>
                            </div>
                        </form>
