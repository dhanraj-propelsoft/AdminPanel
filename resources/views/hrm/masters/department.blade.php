...
<script>
    ...
    document.querySelector(".propel-breadcrumb-extra-content").innerHTML = `<a href="{{ route('hrmDepartment.create') }}"><button class='propelbtn propelbtncurved propeladd propel-hover'>Add</button></a>`;
</script>
@endsection