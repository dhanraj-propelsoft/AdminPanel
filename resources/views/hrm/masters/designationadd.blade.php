...
{{csrf_field()}}
    ...
    <label class="form-group  p-0 mb-4 InputLabel w-100">
      ...
      <label class="form-group m-0  p-0 InputLabel w-100">
        <input type="text" name="no_of_posting" placeholder="No of Posting..." class="form-control AlterInput propel-key-press-input propel-key-press-input-mendatory"  autocomplete="off">
    ...
    <label class="form-group  p-0 mb-4 InputLabel w-100">
      <select class="form-select form-control department search-need" id="department" name="department" >
        <option selected value="">Select Department</option>
        @foreach($datas as $data)
