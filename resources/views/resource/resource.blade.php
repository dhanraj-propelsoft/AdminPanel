...
<script>
    document.querySelector(".propel-breadcrumb-extra-content").innerHTML = `<a href="/add-resource-stage-1"><button class='propelbtn propelbtncurved propeladd propel-hover'>Add</button></a>`;
</script>
@endsection